// Problem 5:
// Write a function `mergeArrays` that takes in two arrays of integers and returns
// a new array that contains all the elements from both arrays, sorted in ascending order.
